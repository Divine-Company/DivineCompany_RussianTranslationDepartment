...
namespace LimbusLocalizeDCLC
{
    public static class DCLC_ReadmeManager
    {
            ...
            {
                {
                    "Action_Issues",()=>
                    {
                        ...
                        Application.OpenURL(LCB_DCLCMod.DCLCLink + "/issues?q=is:issue");
                    }
                }
            };
        }
        ...
        public static void InitReadmeSprites()
        {
            ...
            foreach (FileInfo fileInfo in new DirectoryInfo(LCB_DCLCMod.ModPath + "/Localize/Readme").GetFiles().Where(f => f.Extension is ".jpg" or ".png"))
            {
